...
block:
| expr { $1 }
| expr SEMICOLON exprlist { Past.Seq(get_loc(), $1 :: $3) }
...
expr:
| simple_expr                        {  $1 }
| expr simple_expr                   { Past.App (get_loc(), $1, $2) } // solves e1 (-e2) issue
...
| FUN LPAREN IDENT COLON texpr RPAREN ARROW block END
                                     { Past.Lambda(get_loc(), ($3, $5, $8)) } 
| LET IDENT COLON texpr EQUAL block IN block END           { Past.Let (get_loc(), $2, $4, $6, $8) }
| LET IDENT LPAREN IDENT COLON texpr RPAREN COLON texpr EQUAL block IN block END
                                     { Past.LetFun (get_loc(), $2, ($4, $6, $11), $9, $13) }
| CASE expr OF 
      INL LPAREN IDENT COLON texpr RPAREN ARROW block
  BAR INR LPAREN IDENT COLON texpr RPAREN  ARROW block
  END 
